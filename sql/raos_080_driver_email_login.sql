...
--   - if the driver has no bound email yet, the first successful driver auth
--     session may bind that email once
...
-- this RPC; corrections must be handled explicitly by admin.
