    ...
    ;(async()=>{
      ...
      const [s,a,r,q]=await Promise.all([
        ...
        supabase.from('raos_saldo_requests')
          .select('id,request_no,nominal,status,is_processed,is_archived,requested_at,driver_name,rejection_reason,staff_profile:user_profiles!raos_saldo_requests_staff_id_fkey(full_name,staff_id)')
